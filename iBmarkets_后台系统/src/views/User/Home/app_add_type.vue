  ...
  <div class="app_add_type" style="overflow: hidden;">
    ...
    <el-row class="paylist1" v-show="radio == 1">
      <el-col
        ...
        :sm="24"
        :md="24"
        :lg="item.type == 'usdt'?24:12"
        :xl="item.type == 'usdt'?24:12"
      >
        <div
          class="aItem"
          :class="[item.type,currency==item.type?'active_border':'']"
    ...
    <div class="pay_form_box" :class="screenSize == 1?'':'p_r p_l'" v-show="radio == 1">
      <el-form
        ...
        class="item_form"
      >
        <el-form-item label="汇率" v-if="false">
          <div style="color: #000;">{{ rate }}</div>
        </el-form-item>
